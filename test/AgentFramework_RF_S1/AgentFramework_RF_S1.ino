...
void setup()
{
  ...
  radioAgent1.registerAgent(0, COMM_RF, "R2", RF_TX_PIN, RF_RX_PIN );
  ...
  ACLMessage aclMessage = { agentName, "R2", P_INFORM, "FreeTest", "Hello Agent" };
  radioAgent1.send( aclMessage );
  logLine( aclMessage.content + " Sent" );
}
